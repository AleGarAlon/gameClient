...
function Navbar() {
  ...
  return user.character ? (
    ...
    {/* <Link className= "navLinks" to="/create">Create enemy form</Link> */}
      ...
      <Link className="characterLink" to="character"><div className='navStats'>
        <p className= "navHealth" style={{ width: `${parseFloat(healthPercentage)}rem` }}>{user.character.health}</p> 
